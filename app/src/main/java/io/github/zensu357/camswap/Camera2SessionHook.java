    ...
    public final class Camera2SessionHook {
                ...
                Api101Runtime.requireModule().hook(m).intercept(chain -> {
                    ...
                    try {
                        if (args[0] != null) {
                            ...
                            // ★ VTCam: build input+YUV+JPEG session, skip original List call
                    ...
                    Api101Runtime.requireModule().hook(m).intercept(chain -> {
                        ...
                        try {
                            if (args[1] != null) {
                                ...
                                if (isVtcamSession() && !vtcamApplying) {
                                    @SuppressWarnings("unchecked")
                                    List<Surface> surfaces = (List<Surface>) args[1];
                                    CameraCaptureSession.StateCallback cb =
                    ...
                    Api101Runtime.requireModule().hook(m).intercept(chain -> {
                        ...
                        try {
                            if (args[0] != null) {
                                ...
                                // ★ VTCam re-entry: config already built, pass through untouched
                                if (vtcamApplying) {
                                    hookSessionCallback(
        ...
        // =====================================================================
        // Helper: extract Surface list from List<OutputConfiguration> or List<Surface>
        // =====================================================================
